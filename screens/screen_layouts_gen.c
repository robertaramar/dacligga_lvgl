...
lv_obj_t * screen_layouts_create(void)
{
    ...
    lv_label_set_text(lv_label_0, "Sources");
    ...
    lv_obj_set_style_bg_color(row_1, lv_color_hex(0xffffff), 0);

    lv_obj_t * icon_button_0 = icon_button_create(row_1, icon_midi, lv_color_hex(0xa86868));
    ...
    lv_obj_set_style_bg_color(row_2, lv_color_hex(0xf1f6a7), 0);
    ...
    lv_label_set_text(lv_label_1, "120");
    ...
    lv_obj_set_style_bg_opa(row_3, (255 * 100 / 100), 0);
    lv_obj_set_style_bg_color(row_3, lv_color_hex(0xffffff), 0);
    ...
    lv_obj_set_style_bg_opa(row_4, (255 * 100 / 100), 0);
    lv_obj_set_style_bg_color(row_4, lv_color_hex(0xffffff), 0);
    lv_obj_set_align(row_4, LV_ALIGN_CENTER);

    lv_obj_t * lv_label_2 = lv_label_create(row_4);
    lv_label_set_text(lv_label_2, "Destinations");
    lv_obj_set_style_text_font(lv_label_2, big_shoulders_14, 0);
